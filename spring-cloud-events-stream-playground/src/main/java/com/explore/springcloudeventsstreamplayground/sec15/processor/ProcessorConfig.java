package com.explore.springcloudeventsstreamplayground.sec15.processor;

import com.explore.springcloudeventsstreamplayground.sec15.dto.DigitalDelivery;
...
public class ProcessorConfig {
    ...
    private Message<?> dispatch(Order order) {
        ...
        this.simulateNetworkCall(); // simulating slow service call or database call
