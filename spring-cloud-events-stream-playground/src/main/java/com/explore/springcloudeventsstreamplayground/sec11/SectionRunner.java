package com.explore.springcloudeventsstreamplayground.sec11;
...
public class SectionRunner {
    ...
    static class DigitalDeliveryConsumer {
        static void main() {
            SpringApplication.run(
                    DigitalDeliveryConsumer.class, "--section=sec11", "--config=01-digital-consumer"
            );
        }
    }
    ...
    static class PhysicalDeliveryConsumer {
        static void main() {
            SpringApplication.run(
                    PhysicalDeliveryConsumer.class, "--section=sec11", "--config=02-physical-consumer"
            );
        }
    }
    ...
    static class Processor {
        static void main() {
            SpringApplication.run(
                    Processor.class, "--section=sec11", "--config=03-processor"
            );
        }
    }
    ...
    static class Producer {
        static void main() {
            SpringApplication.run(
                    Producer.class, "--section=sec11", "--config=04-producer"
            );
        }
    }
}
